angular.module("generalDataViewApp", []).controller("generalDataViewCtrl", ['$scope', '$interval','$timeout','getDataService', 'getDataServicePos',
function($scope, $interval,$timeout,getDataService, getDataServicePos) {
